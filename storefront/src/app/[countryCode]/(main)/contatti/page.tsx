...
export const metadata: Metadata = {
  title: "Contatti",
  description: "Contattaci per qualsiasi domanda o informazione sui nostri prodotti e servizi.",
}
  ...
  return (
    <div className="content-container py-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 text-center">Contattaci</h1>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    info@iltuostore.com<br />
                    assistenza@iltuostore.com
                  </p>
                </div>
              </div>
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="informazioni">Informazioni sui prodotti</option>
                  <option value="ordine">Domande sull'ordine</option>
                  <option value="resos">Resi e rimborsi</option>
              ...
              <div className="flex items-center">
                ...
                <label htmlFor="privacy" className="ml-2 block text-sm text-gray-700">
                  Accetto la <a href="#" className="text-blue-600 hover:text-blue-500">Privacy Policy</a> *
                </label>
              </div>
        ...
        {/* Mappa */}
        <div className="mt-12">
          <h2 className="text-2xl font-semibold mb-6 text-center">Dove Siamo</h2>
          <div className="bg-gray-200 h-64 rounded-lg flex items-center justify-center">
            <p className="text-gray-500">Mappa interattiva (da integrare con Google Maps)</p>
          </div>
        </div>
      </div>
    </div>
